...
public class LightSettingsDialog extends AlertDialog implements
    ...
    private void updateLed() {
        ...
        b.putInt(MKNotification.EXTRA_FORCE_PREVIEW_COLOR, color);
        b.putInt(MKNotification.EXTRA_FORCE_PREVIEW_LIGHT_ON_MS, speedOn);
        b.putInt(MKNotification.EXTRA_FORCE_PREVIEW_LIGHT_OFF_MS, speedOff);
