 ...
 */
package org.mokee.mkparts.search;
...
import org.mokee.mkparts.search.Searchable.SearchIndexProvider;
...
import static org.mokee.internal.mkparts.PartsList.MKPARTS_ACTIVITY;
import static org.mokee.internal.mkparts.PartsList.MKPARTS_PACKAGE;
import static org.mokee.internal.mkparts.PartsList.getPartInfo;
import static org.mokee.internal.mkparts.PartsList.getPartsList;

/**
 * Provides search metadata to the Settings app
 */
public class MKPartsSearchIndexablesProvider extends SearchIndexablesProvider {

    private static final String TAG = MKPartsSearchIndexablesProvider.class.getSimpleName();
    ...
    public Cursor queryXmlResources(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_XML_RES_ICON_RESID] = R.drawable.ic_launcher_mokee;
            ref[COLUMN_INDEX_XML_RES_INTENT_ACTION] = i.getAction();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_PACKAGE] = MKPARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_XML_RES_INTENT_TARGET_CLASS] = MKPARTS_ACTIVITY.getClassName();
            cursor.addRow(ref);
        }
        return cursor;
    ...
    public Cursor queryRawData(String[] strings) {
        ...
        for (String key : keys) {
            ...
            ref[COLUMN_INDEX_RAW_ICON_RESID] = i.getIconRes() > 0 ? i.getIconRes() :
                    R.drawable.ic_launcher_mokee;
            ref[COLUMN_INDEX_RAW_INTENT_ACTION] = i.getAction();
            ref[COLUMN_INDEX_RAW_INTENT_TARGET_PACKAGE] = MKPARTS_ACTIVITY.getPackageName();
            ref[COLUMN_INDEX_RAW_INTENT_TARGET_CLASS] = MKPARTS_ACTIVITY.getClassName();
