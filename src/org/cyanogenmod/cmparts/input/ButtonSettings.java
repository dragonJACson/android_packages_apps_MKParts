...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int statusNavButtonsHeight = CMSettings.System.getInt(getContentResolver(),
                CMSettings.System.NAVIGATION_BAR_HEIGHT, 48);
        ...
        if (hardware.isSupported(CMHardwareManager.FEATURE_KEY_DISABLE) || !needsNavigationBar) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mHomeLongPressAction ||
            ...
            handleListChange(mNavigationBarHeight, newValue,
                    CMSettings.System.NAVIGATION_BAR_HEIGHT);
            return true;
